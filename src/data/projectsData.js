// Icon mapping utility - returns icon name instead of JSX
export const getIconName = (tech) => {
...
// Project data - moved from Portfolio component for better code splitting
export const projects = [
  ...
  },
  {
    ...
    screenshots: [
      {
        path: "/math.png",
        caption: "Clean, intuitive interface for math practice"
      }
    ],
    features: [
      "Interactive math problems with multiple choice answers",
    ...
    challenges: [
      "Creating engaging content that maintains user interest",
      "Ensuring accessibility for younger users",
      "Balancing simplicity with functionality"
    ],
    approach: [
      { 
        title: "User-Centered Design", 
        description: "Focused on creating an intuitive interface that wouldn't overwhelm or confuse users." 
      },
      { 
        title: "Progressive Enhancement", 
        description: "Built with vanilla JavaScript to ensure fast loading and compatibility across all devices." 
      },
      { 
        title: "Accessibility First", 
        description: "Implemented keyboard navigation and clear visual feedback for all user interactions." 
      }
    ],
    results: [
      { value: "500+", label: "Students using the application" },
